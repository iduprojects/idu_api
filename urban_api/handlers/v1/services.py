...
from urban_api.logic.services import (
    add_service_to_db,
...
from urban_api.schemas import ServicesData, ServicesDataPatch, ServicesDataPost, ServicesDataPut, ServiceWithTerritories
...
async def add_service_to_objects(
    ...
    service_dto = await add_service_to_object_in_db(conn, service_id, physical_object_id, object_geometry_id)
