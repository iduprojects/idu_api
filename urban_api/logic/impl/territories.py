...
class TerritoriesServiceImpl(TerritoriesService):
    ...
    async def get_territories_by_id_from_db(self, territory_ids: list[int]) -> list[TerritoryDTO]:
        return await get_territories_by_id_from_db(self._conn, territory_ids)

    async def get_territory_by_id_from_db(self, territory_id: int) -> TerritoryDTO:
        return await get_territory_by_id_from_db(self._conn, territory_id)
    ...
    async def get_services_capacity_by_territory_id_from_db(
        self, territory_id: int, service_type_id: int | None
    ) -> int:
