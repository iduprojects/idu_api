...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'indicator_id',
            sa.Integer(),
            server_default=sa.text("nextval('indicators_dict_id_seq')"),
            nullable=False),
        sa.Column('name', sa.String(length=200), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f('indicators_dict_fk_parent_id__indicators_dict')),
    ...
    op.create_table(
        ...
        sa.Column(
            'territory_id',
            sa.Integer(),
            server_default=sa.text("nextval('territories_data_id_seq')"),
            nullable=False),
    ...
    op.create_table('functional_zones_data',
    sa.Column(
        'functional_zone_id',
        sa.Integer(),
    ...
    op.create_table('living_buildings_data',
    sa.Column(
        'living_building_id',
        sa.Integer(),
    ...
    op.create_table('object_geometries_data',
    sa.Column(
        'object_geometry_id',
        sa.Integer(),
    ...
    op.create_table('service_types_normatives_data',
    sa.Column(
        'normative_id',
        sa.Integer(),
    ...
    op.create_table('services_data',
    sa.Column(
        'service_id',
        sa.Integer(),
        server_default=sa.text("nextval('services_data_id_seq')"),
        nullable=False),
    sa.Column('service_type_id', sa.Integer(), nullable=False),
    sa.Column('territory_type_id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=200), nullable=False),
    ...
    op.create_table('territory_indicators_data',
    sa.Column('indicator_id', sa.Integer(), nullable=False),
    sa.Column('territory_id', sa.Integer(), nullable=False),
    sa.Column(
        'date_type',
        sa.Enum('year', 'half_year', 'quarter', 'month', 'day', name='date_field_type'),
        nullable=False),
    sa.Column('date_value', sa.Date(), nullable=False),
    sa.Column('value', sa.Float(precision=53), nullable=False),
    sa.Column(
        'value_type',
        sa.Enum('real', 'forecast', 'target', name='indicator_value_type'),
        nullable=False),
    ...
    sa.PrimaryKeyConstraint(
        ...
        name=op.f('territory_indicators_data_pk'))
    )

    op.create_table('urban_objects_data',
    sa.Column(
        'urban_object_id',
        sa.Integer(),
