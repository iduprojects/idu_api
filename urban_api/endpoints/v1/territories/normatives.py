...
"""Normatives territories-related endpoints are defined here."""
...
def get_territory_normatives(
    territory_id: int = Path(description="territory id", gt=0), connection: AsyncConnection = Depends(get_connection)
) -> list[Normative]:
