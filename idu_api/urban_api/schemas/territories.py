...
from idu_api.urban_api.dto import TargetCityTypeDTO, TerritoryDTO, TerritoryTypeDTO, TerritoryWithoutGeometryDTO, TerritoryTreeWithoutGeometryDTO
...
class TerritoryTreeWithoutGeometry(TerritoryWithoutGeometry):
    ...
    def from_dto(cls, dto: TerritoryTreeWithoutGeometryDTO) -> "TerritoryTreeWithoutGeometry":
        ...
        return cls(
            ...
            territory_type=TerritoryTypeBasic(id=dto.territory_type_id, name=dto.territory_type_name),
            parent=(
                ShortTerritory(id=dto.parent_id, name=dto.parent_name) 
            ...
            updated_at=dto.updated_at,
            children=[
                TerritoryTreeWithoutGeometry.from_dto(child_dto) 
