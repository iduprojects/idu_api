...
async def get_city_geometry(
    request: Request, city: Annotated[int | str, Path(description="city id or name")]
) -> Geometry:
...
async def get_physical_objects_by_city_id(
    ...
    result: list[PhysicalObjectsDTO] = await physical_objects_service.get_physical_objects_by_territory_id(city, city)
