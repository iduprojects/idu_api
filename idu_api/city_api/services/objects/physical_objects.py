...
from idu_api.city_api.services.territories.territories import get_territory_ids_by_parent_id, get_ca_territory_by_id
...
class PhysicalObjectsService:
    ...
    async def get_physical_objects_by_territory_id(self, city_id: int | str, territory_id: int | str) -> list[PhysicalObjectsDTO]:
