...
buildings_data_id_seq = Sequence("buildings_data_id_seq")

buildings_data = Table(
    "buildings_data",
    metadata,
    Column("building_id", Integer, primary_key=True, server_default=buildings_data_id_seq.next_value()),
    Column(
