...
def upgrade() -> None:
    ...
    op.alter_column("projects_functional_zones", "year", nullable=False, schema="user_projects")
    op.alter_column("projects_functional_zones", "source", nullable=False, schema="user_projects")
...
def downgrade() -> None:
    ...
    op.alter_column("projects_functional_zones", "year", nullable=True, schema="user_projects")
    op.alter_column("projects_functional_zones", "source", nullable=True, schema="user_projects")
